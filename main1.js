...
const hodPosterTexture = textureLoader.load('textures/HOD.jpg');
...
class Pedestrian {
  constructor(x, z) {
    ...
    gltfLoader.load('men.glb', (gltf) => {
      ...
      console.warn('Could not load men.glb model, using fallback geometry:', error.message);
